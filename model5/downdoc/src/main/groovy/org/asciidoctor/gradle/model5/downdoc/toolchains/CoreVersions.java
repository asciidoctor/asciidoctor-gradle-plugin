...
/**
 * Configuring core versions for {@code downdoc}.
 *
...
public interface CoreVersions {
    /**
     * Overrides the default version of {@code downdoc}.
     *
...
//    void useNode(Object v);
    ...
    /**
     * Uses the PNPM toolchain to run {@code downdoc}
     *
     * @param name Name of toolchain from {@code jsEcosystem} extension.
     */
    void usePnpmToolchain(String name);
}
