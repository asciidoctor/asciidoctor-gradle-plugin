...
import org.asciidoctor.gradle.model5.downdoc.internal.toolchains.DowndocToolchainFactory
import org.asciidoctor.gradle.model5.downdoc.toolchains.DowndocToolchain
import org.gradle.api.Plugin
import org.gradle.api.Project

/**
 * {@code downdoc} base plugin.
 *
 ...
 */
@CompileStatic
class DowndocBasePlugin implements Plugin<Project> {
    @Override
    void apply(Project project) {
        ...
        asciidoc.toolchains.registerFactory(
                DowndocToolchain,
                project.objects.newInstance(DowndocToolchainFactory)
        )

        DowndocModel.registerOutputFormatterFactory(
                asciidoc.toolchains,
                DowndocMarkdownOutputFormatter,
                DefaultDowndocMarkdownOutputFormatter.Factory,
                project.objects
        )
    }
}
