...
class AsciidoctorjHtml5Factory implements NamedDomainObjectFactory<AsciidoctorjHtml5> {
    ...
    @Inject
    AsciidoctorjHtml5Factory(AsciidoctorjToolchain toolchain, Project project) {
        this.objectFactory = project.objects
        this.toolchain = toolchain
    }

    @Override
    AsciidoctorjHtml5 create(String name) {
        objectFactory.newInstance(DefaultAsciidoctorjHtml5, name, toolchain)
    }
}
