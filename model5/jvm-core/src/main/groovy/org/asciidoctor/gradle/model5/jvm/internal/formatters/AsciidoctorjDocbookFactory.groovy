...
class AsciidoctorjDocbookFactory implements NamedDomainObjectFactory<AsciidoctorjDocbook> {
    ...
    @Inject
    AsciidoctorjDocbookFactory(AsciidoctorjToolchain toolchain, Project project) {
        this.objectFactory = project.objects
        this.toolchain = toolchain
    }

    @Override
    AsciidoctorjDocbook create(String name) {
        objectFactory.newInstance(DefaultAsciidoctorjDocbook, name, toolchain)
    }
}
