 ...
 * @since 5.0
 */
public interface AsciidoctorjsGenericOutputFormatter extends AsciidoctorjsOutputFormatter,
        AsciidoctorGenericOutputFormatter {

    /**
     * Set hte package from the NPM repository here.
     *
