...
import static org.asciidoctor.gradle.model5.js.formatters.SupportedTemplateEngines.TEMPLATE_JS
import static org.gradle.testkit.runner.TaskOutcome.SUCCESS

class TemplatesSpec extends AsciidoctorjsHtmlIntegrationSpecification {
    ...
    void 'Can apply the #engine-based template'() {
        ...
        buildFile << """
        asciidoc.toolchains.asciidoctorjs.registeredOutputFormatters.html {
        ...
        where:
        engine << DefaultAsciidoctorjsTemplates.SUPPORTED_TEMPLATE_ENGINES
    }
