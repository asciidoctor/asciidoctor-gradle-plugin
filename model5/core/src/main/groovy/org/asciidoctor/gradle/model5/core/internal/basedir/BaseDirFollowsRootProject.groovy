...
/**
 * Strategy where the project root directory is always to be base directory
 ...
 */
@CompileStatic
class BaseDirFollowsRootProject extends BaseDirIsFixedPath implements BaseDirStrategy {
