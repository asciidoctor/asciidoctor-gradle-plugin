...
class AsciidoctorEpubTaskFunctionalSpec extends FunctionalSpecification {
    ...
    void 'Run a EPUB generator with format EPUB3'() {
        given:
    ...
    @Unroll
    void 'Run a EPUB generator with multiple formats in order #formatOrder'() {
        given:
        getBuildFile("""
    ...
    File getBuildFile(String extraContent) {
        writeGroovyBuildFile('org.asciidoctor.jvm.epub.classic', extraContent)
    }
}