...
class AsciidoctorUtils {
    ...
    public static final String RESOURCE_PREFIX = 'META-INF/asciidoctor.gradle'
    ...
    /** Apply convention in way that is backward-compatible to Gradle 4.3, but utilises features
    ...
    /** Creates a {@link DirectoryProperty} instance in a way that is backwards-compatible to
     * Gradle 4.3.
     *
     * @param project Current project context
