...
import org.ysb33r.grolifant5.api.core.git.AbstractCloudGit;
 ...
 * @param <ResolvedComponent> Final component type
 * @since 2.0
 */
public abstract class AbstractDownloadableComponent<ComponentSrc, ResolvedComponent> {

    /**
     * Re-usable instance of {@link ProjectOperations}
     *
     */
     ...
     * @throws UnknownDomainObjectException is the component has not been registered.
     */
     ...
     * Protected c-tor.
     *
     * @param project Temporary project reference.
     */
