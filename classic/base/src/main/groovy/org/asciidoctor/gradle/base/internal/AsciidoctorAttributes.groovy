...
class AsciidoctorAttributes {
     ...
     */
    static Map<String, Object> resolveAsCacheable(Map<String, Object> attrs, ConfigCacheSafeOperations po) {
    ...
    private static Map<String, Object> resolveMapRecursive(Map<String, Object> attrs, ConfigCacheSafeOperations po) {
        final Map<String, Object> resolvedAs = [:] as TreeMap<String, Object>
        attrs.forEach { String key, Object value ->
            switch (value) {
                case Map:
    ...
    private static Collection<Object> resolveCollectionRecursive(
            Collection<Object> attrValues,
    ...
    private static Object resolveSingleItem(Object value, ConfigCacheSafeOperations po) {
        switch (value) {
            case Map:
            ...
            case Callable:
                return po.providerTools().provider(value as Callable<Object>)
            case Supplier:
                return po.providerTools().provider({ -> ((Supplier) value).get() } as Callable<Object>)
            case URI:
            case URL:
            case Provider:
            case File:
            ...
            case Boolean:
                return value
            default:
                return po.providerTools().provider { -> po.stringTools().stringize(value) }
        }
    }
}
