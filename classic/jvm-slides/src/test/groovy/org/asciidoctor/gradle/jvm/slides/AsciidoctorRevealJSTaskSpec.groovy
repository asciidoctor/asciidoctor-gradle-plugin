...
class AsciidoctorRevealJSTaskSpec extends Specification {
    ...
    void 'Configure revealjs task'() {
        given:
        project.apply plugin: 'org.asciidoctor.jvm.revealjs.classic'
        AsciidoctorJRevealJSTask revealjsTask = project.tasks.register('foo', AsciidoctorJRevealJSTask).get()
