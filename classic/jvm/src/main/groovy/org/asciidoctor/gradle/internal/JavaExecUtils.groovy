...
class JavaExecUtils {
    ...
    static File getInternalGradleLibraryLocation(ConfigCacheSafeOperations po, final Pattern libraryPattern) {
        ...
        File[] files = new File(po.fsOperations().gradleHomeDir.get(), 'lib').listFiles(filter)
