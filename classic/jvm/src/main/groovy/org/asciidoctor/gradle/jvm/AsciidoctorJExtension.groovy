...
class AsciidoctorJExtension extends AbstractImplementationEngineExtension {
    ...
    private final String privateConfigurationName
...
//        this.dependencyCreator = createDependencyLoader(project.dependencies, this.privateConfiguration.name)
        this.projectDependency = createProjectDependencyLoader()
    ...
    AsciidoctorJExtension(Task task) {
        ...
        this.privateConfigurationName = privateName
        this.deps = task.project.dependencies
        projectOperations.configurations.createLocalRoleFocusedConfiguration(privateName, publicName, false)
...
//        this.dependencyCreator = createDependencyLoader(task.project.dependencies, this.privateConfiguration.name)
        this.projectDependency = createProjectDependencyLoader()
        this.modules = new DefaultAsciidoctorJModules(projectOperations, this, defaultVersionMap)
        this.modules.onUpdate { owner.updateConfiguration() }
        updateConfiguration()
...
//    private BiFunction<String, Closure, Dependency> createDependencyLoader(DependencyHandler deps, String cfgName) {
//        { String coords, Closure configurator ->
//            if (configurator != null) {
//                deps.add(cfgName, coords, configurator)
//            } else {
//                deps.add(cfgName, coords)
//            }
//        } as BiFunction<String, Closure, Dependency>
//    }

    private Function<Project, Dependency> createProjectDependencyLoader() {
        { Project p ->
