...
class JRubyTestVersions {
    ...
    public final static String AJ20_SAFE_MINIMUM = '9.2.3.0'
    ...
    public final static String AJ16_SAFE_MAXIMUM = '9.2.5.0'
    public final static String AJ16_ABSOLUTE_MAXIMUM = '9.2.5.0'
    // ----------------------------------------------------------
