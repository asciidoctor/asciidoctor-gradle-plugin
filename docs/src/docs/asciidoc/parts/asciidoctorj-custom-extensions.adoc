...
In the less-common case where extension is not supplied via the default configuration, the latter shortcurt will not work, and you will need to use the longer method described above.
