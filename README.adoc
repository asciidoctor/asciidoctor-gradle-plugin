...
image:https://api.bintray.com/packages/asciidoctor/maven/{project-full-path}/images/download.svg[Download, link="https://bintray.com/asciidoctor/maven/{project-full-path}"]
