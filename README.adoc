...
image:https://ci.appveyor.com/api/projects/status/db102rphsu5lviv6/branch/{github-branch}?svg=true[Build Status", link="https://ci.appveyor.com/project/{project-full-path}/branch/{github-branch}"]
...
image:http://img.shields.io/badge/download-latest-bb00bb.svg[link="https://bintray.com/aalmiray/{project-full-path}/_latestVersion"]
