...
image:http://img.shields.io/travis/asciidoctor/{project-name}/{github-branch}.svg["Build Status", link="https://travis-ci.org/asciidoctor/{project-name}"]
image:http://img.shields.io/coveralls/asciidoctor/{project-name}/{github-branch}.svg["Coverage Status", link="https://coveralls.io/r/asciidoctor/{project-name}"]
