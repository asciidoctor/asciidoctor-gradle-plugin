...
NOTE: If you are using Gradle 5.5+ you will need at least v2.3.0 of the plugins.

NOTE: The 2.x range of these plugins are NOT compatible with https://github.com/spring-projects/spring-restdocs[Spring REST Docs]. If you have to use the latter then stick to the older v1.5.11 or v1.5.12 versions and do not manually set the version of AsciidoctorJ in your build script.
